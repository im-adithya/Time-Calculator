...
This is a function named `add_time` that takes in two required parameters and one optional parameter:
...
Below are some examples of different cases the function can handle:
```py
